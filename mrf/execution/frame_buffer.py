import numpy as np
from .mathex import quaternion_multiply, quaternion_slerp
...
class FrameBuffer:
    ...
    def from_armature_obj(self, armature_obj):
        armature_obj.pose.bones.foreach_get("location", self.position_data.ravel())
        armature_obj.pose.bones.foreach_get("rotation_quaternion", self.rotation_data.ravel())
        armature_obj.pose.bones.foreach_get("scale", self.scale_data.ravel())
